class Prestamo():
	...
	def valor_total(self,prestamo,tiempo):
		if(prestamo>0 and prestamo<5000 and tiempo>=1 and tiempo<=3):
		...
		elif(prestamo>=5000 and prestamo<10000 and tiempo>=1 and tiempo<=6):
			comision=(prestamo*3)/100
			capital_total=float(prestamo+comision)
			interes=float(((capital_total*1.25)/100)*tiempo)
			return float(capital_total+interes)
		elif(prestamo>=10000 and prestamo<=20000 and tiempo>=1 and tiempo<=12):
