...
class AddTest(unittest.TestCase):
   ...
   def test_prestamoMenorCeroDos(self):
       self.assertEqual(self.prestamo.valor_total(0,1),None)
   ...
   def test_prestamoMenor5000Dos(self):
       self.assertEqual(self.prestamo.valor_total(4099,3),4306.4094)
   ...
   def test_prestamoMMayor20000(self):
       self.assertEqual(self.prestamo.valor_total(50000,11),None)
